    ...
    return (
      <Layout>
        <div className="text-center py-12">
          ...
          <Link to="/elections" className="text-primary-500 mt-4 inline-block">
            Back to Elections
          </Link>
        </div>
      </Layout>
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mt-4">
            {results.election?.title || "Election Results"}
          </h1>
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <span className="text-sm text-gray-400">
              {formatDate(results.election?.start_datetime)} -{" "}
              {formatDate(results.election?.end_datetime)}
            </span>
          </div>
        </div>
        ...
        {isElectionClosed && results.winner && (
          <div
            className={`bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl p-6 mb-8 text-white ${results.is_tie ? "from-gray-500 to-gray-600" : ""}`}
          >
              ...
              <div>
                ...
                {results.is_tie && (
                  <p className="text-sm mt-2 font-semibold">
                    ⚠️ This election ended in a tie!
                  </p>
                )}
              </div>
            </div>
